...
# Fail closed on characters that should never silently reach Korean commercial fiction.
FORBIDDEN_PATTERNS = [
...
# Deterministic typo/redundancy catches observed in the pilot and safe to flag.
SUSPECT_PHRASES = [
    "시커룝게",
    "푸른 청색광",
    "거센 거친",
...
def scan_text(text: str):
    ...
    # Catch control characters except normal whitespace.
    for ch in text:
        if ch in "\n\r\t":
            continue
